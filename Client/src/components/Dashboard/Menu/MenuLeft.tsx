    ...
    return (
        <div className="flex flex-col h-screen w-[20vw] justify-start px-10">
            <ul className='flex flex-col gap-2 my-20'>
                <li className=' flex flex-row justify-start px-2 gap-5 py-3 w-full font-normal hover:bg-[#827d7d21] hover:dark:bg-white hover:dark:bg-transparent hover:dark:bg-opacity-25 rounded-lg block dark:text-white'>
                    <GroupIcon className='text-red-500'/>
                    <span className='menu-title'>Groups</span></li>
                <li className='flex flex-row justify-start px-2 gap-5 py-3 w-full font-normal hover:bg-[#827d7d21] hover:dark:bg-white hover:dark:bg-transparent hover:dark:bg-opacity-25 rounded-lg block text-dark dark:text-white'>
